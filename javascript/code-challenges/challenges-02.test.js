...
const raisedToTheThird = (arr) => {
  let newArray = [];
  arr.forEach(item => {
    let raised = Math.pow(item, 3)
    newArray.push(raised);
  })
  return newArray;
};
...
const addOne = (arr) => {
  let mapped = arr.map(item => item + 1);
  return mapped;
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    let raised1 = Math.pow(2, arr[i]);
    newArray1.push(raised1);
};
  return newArray1;
};
...
const forEachTwoToThe = (arr) => {
  let newArray2 = [];
  arr.forEach(item => {
    let raised2 = Math.pow(2, item);
    newArray2.push(raised2);
  })
  return newArray2;
};
...
const mapTwoToThe = (arr) => {
  let mapped2 = arr.map(item => Math.pow(2,item));
  return mapped2;
};
...
const charCode = (arr) => {
  let newChars = [];
  newChars = arr.map(item => item.charCodeAt(0));
  return newChars;
};
