...
const getNames = (arr) => {
  let reversePeople = arr.map(person => person.name.split("").reverse().join(""));
  return reversePeople;
};

// Pulled this logic from Rey's demo this morning of last Friday's code challenge. Still wrapping my head around this level of chaining
